...
const draft = { chain: '61997', contract: `0x${'1'.repeat(40)}` as const, account: `0x${'2'.repeat(40)}` as const, method: 'play_word', intent: 'play_word:1:2:0', args_json: '[]', pre_revision: '2', pre_hash: 'a'.repeat(64) };
